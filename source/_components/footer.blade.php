<footer class="bg-footer w-full">
  <div class="py-12 sm:py-24 px-6 sm:px-12 lg:px-24">
    <div class="flex flex-col lg:flex-row lg:justify-between">
      <div class=>
        <a href="/"><img class="mx-auto lg:mx-0 w-40 lg:w-60" src="../assets/images/logo-inverted.svg" alt="Markham Square's Logo"/></a>
    ...
    <div class="flex flex-col-reverse lg:flex-row justify-between items-center mt-8 lg:mt-12">
      ...
      <div class="flex md:justify-end">
        {{-- LinkedIn --}}
        <a href="https://www.linkedin.com/company/markham-square" target="_blank" rel="noopener noreferrer" class="text-white hover:text-orange-500 transition-sm outline-primary">
        ...
        {{-- Twitter --}}
        <a href="https://twitter.com/team_markhamsq" target="_blank" rel="noopener noreferrer" class="ml-8 text-white hover:text-orange-500 transition-sm outline-primary">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 lg:h-10 lg:w-10" viewBox="0 0 256 256">
            <rect width="256" height="256" fill="none"></rect>
