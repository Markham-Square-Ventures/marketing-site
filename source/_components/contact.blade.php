<section class="bg-orange-50 relative w-full py-24 mx-6 sm:mx-12 lg:mx-26">
  <img src="../assets/images/contact-bg.svg" alt="" class="absolute top-0 right-0 z-0"/>

  <h3 class="h2">We would love to <br/>work with your project.</h3>
  <div class="relative">
    <form action="" class="p-12 mt-16 max-w-[840px] bg-white shadow-secondary ">
      ...
      <button class="btn btn-lg mt-7">
        Send
      </button>
    </form>
  
    <div class="-mt-10 bg-white border-3 shadow-secondary max-w-[570px] mx-auto px-12 pt-12 pb-14">
